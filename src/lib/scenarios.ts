...
export const SCENARIOS: Scenario[] = [
  ...
  {
    id: "faq-cache",
    name: "Caching: Hit / Miss",
    description: "Send twice to see MISS then HIT. Zero tokens on the cached response.",
